...
def feet_to_acres(square_footage):
    ...
    """
    # Calculations
    # TODO: Calculate acre in given square feet.
    acres = square_footage / SQUARE_FEET_PER_ACRE
...
def math_quiz():
    ...
    The function asks a user to enter an answer, then displays the user
    answer along with the expected answer.
    Use: math_quiz()
    -------------------------------------------------------
    Parameters:
        None
    ...
    ------------------------------------------------------
    """
    # TODO: get two random numbers
    random_number1 = randint(0, 999)
    random_number2 = randint(0, 999)

    # TODO: print random numbers
    print(f"{random_number1:7d}")
    print(f"+{random_number2:6d}")
    ...
    # Output
    # TODO: print out results of quiz
    print('')
    print(f'Your answer:{user_answer:5d}')
    print(f'Expected:{random_number1+random_number2:8d}')
